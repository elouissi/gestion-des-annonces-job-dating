 ...
 <div class="card">
    ...
    <div class="ds-info">
      ...
      <div class="ds projects">
        <h6 title="Number of projects created by the user">anonce <i class="fas fa-project-diagram"></i></h6>
        <p>0</p>
      </div>
      <div class="ds posts">
        <h6 title="Number of posts">applys <i class="fas fa-comments"></i></h6>
        <p>0</p>
      </div>
    </div>
    <div class="ds-skill">
